...
// Testar o CNPJ específico usado no test_frontend_token.php
$cnpj = '12.345.678/0001-90';

echo "=== TESTE CNPJ ESPECÍFICO: {$cnpj} ===\n";
...
if ($cnpj_limpo[12] != $digit1) {
    echo "ERRO: Primeiro dígito não confere - CNPJ INVÁLIDO\n";
    exit;
}
...
if ($cnpj_limpo[13] != $digit2) {
    echo "ERRO: Segundo dígito não confere - CNPJ INVÁLIDO\n";
    exit;
}
